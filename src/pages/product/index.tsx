...
const Collection: React.FC<Props> = (props) => {
  ...
  return (
    <>
      ...
      >
        <div className="sm:w-3/6 sm:h-5/6 h-2/3 w-full flex items-center justify-center animate-right ">
        ...
        <div className="sm:w-4/6 sm:h-5/6 h-2/3 flex-col text-left  flex items-center justify-center gap-6 ">
          <div className="w-full h-4/6 bg-slate-800 rounded-3xl flex flex-col items-center sm:items-start justify-evenly px-8 animate-left">
          ...
          <div className="w-full h-2/6 rounded-3xl relative animate-bottom">
            <Image
